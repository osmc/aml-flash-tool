...
Please read the file _install_/README before to proceed here.

After you have installed correctly the update binary tool, please ensure the flash-tool is in your path:

$ export PATH=/path/to/flash-tool:$PATH
